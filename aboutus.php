...
<body>
<div style="width: 50%;  margin-top:20px;  float: center;" class="col-md-10 offset-md-1 border rounded mt-5 bg-white h-21" >
 <div class="col-md-6">
      <h3 style=" margin-top:15px; "class="text-success">TH Koeln</h3>
      <hr>
      <h4>Team 03</h4>
      <h4>LCSS Lab Project</h4>
 </div>
</div>
